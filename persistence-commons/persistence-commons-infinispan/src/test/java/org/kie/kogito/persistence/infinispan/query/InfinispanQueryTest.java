...
class InfinispanQueryTest {
    ...
    private static Stream<Arguments> provideFilters() {
        return Stream.of(
                ...
                Arguments.of(
                        asList(in("id",
                                asList("8035b580-6ae4-4aa8-9ec0-e18e19809e0b", "a1e139d5-4e77-48c9-84ae-34578e904e5a"))),
                ...
                Arguments.of(
                        asList(and(asList(notNull("name"), contains("name", "test"))),
                                or(asList(lessThanEqual("priority", 1), greaterThan("priority", 1)))),
                ...
                Arguments.of(
                        asList(or(asList(isNull("name"), contains("name", "test"))),
                                and(asList(between("start", "2019-01-01", "2020-01-01"),
                                        or(asList(lessThanEqual("priority", 1), greaterThan("priority", 1)))))),
