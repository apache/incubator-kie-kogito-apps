...
class MongoQueryIT {
    ...
    @Test
    void testExecute() {
        collection.insertOne(new Document(MongoOperations.ID, "1").append(TEST_ATTRIBUTE, "2"));
        collection.insertOne(new Document(MongoOperations.ID, "2").append(TEST_ATTRIBUTE, "5"));
        collection.insertOne(new Document(MongoOperations.ID, "3").append(TEST_ATTRIBUTE, "7"));
        collection.insertOne(new Document(MongoOperations.ID, "4").append(TEST_ATTRIBUTE, "10"));
        collection.insertOne(new Document(MongoOperations.ID, "5").append(TEST_ATTRIBUTE, "11"));
