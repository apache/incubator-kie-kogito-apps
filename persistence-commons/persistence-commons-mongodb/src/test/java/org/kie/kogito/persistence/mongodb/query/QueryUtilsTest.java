...
class QueryUtilsTest {
    ...
    void testGenerateQuery() {
        Optional<Bson> result = QueryUtils.generateQuery(List.of(contains("test", "testValue")),
                new MockMongoEntityMapper()::convertToMongoAttribute);
    ...
    void testGenerateSingleQuery_contains() {
        Bson result = QueryUtils.generateSingleQuery(contains("test", "testValue"),
                new MockMongoEntityMapper()::convertToMongoAttribute);
    ...
    void testGenerateSingleQuery_equalTo() {
        Bson result = QueryUtils.generateSingleQuery(equalTo("test", "testValue"),
                new MockMongoEntityMapper()::convertToMongoAttribute);
        assertEquals(Filters.eq("test", "testValue"), result);
    }
    ...
    void testGenerateSingleQuery_like() {
        Bson result =
                QueryUtils.generateSingleQuery(like("test", "testValue"), new MockMongoEntityMapper()::convertToMongoAttribute);
    ...
    void testGenerateSingleQuery_greaterThan() {
        Bson result = QueryUtils.generateSingleQuery(greaterThan("test", "testValue"),
                new MockMongoEntityMapper()::convertToMongoAttribute);
    ...
    void testGenerateSingleQuery_greatThanEqual() {
        Bson result = QueryUtils.generateSingleQuery(greaterThanEqual("test", "testValue"),
                new MockMongoEntityMapper()::convertToMongoAttribute);
    ...
    void testGenerateSingleQuery_lessThan() {
        Bson result = QueryUtils.generateSingleQuery(lessThan("test", "testValue"),
                new MockMongoEntityMapper()::convertToMongoAttribute);
    ...
    void testGenerateSingleQuery_lessThanEqual() {
        Bson result = QueryUtils.generateSingleQuery(lessThanEqual("test", "testValue"),
                new MockMongoEntityMapper()::convertToMongoAttribute);
    ...
    void testGenerateSingleQuery_between() {
        Bson result = QueryUtils.generateSingleQuery(between("test", "testValue1", "testValue2"),
                new MockMongoEntityMapper()::convertToMongoAttribute);
    ...
    void testGenerateSingleQuery_in() {
        Bson result = QueryUtils.generateSingleQuery(in("test", List.of("testValue")),
                new MockMongoEntityMapper()::convertToMongoAttribute);
    ...
    void testGenerateSingleQuery_containsAll() {
        Bson result = QueryUtils.generateSingleQuery(containsAll("test", List.of("testValue")),
                new MockMongoEntityMapper()::convertToMongoAttribute);
    ...
    void testGenerateSingleQuery_containsAny() {
        Bson result = QueryUtils.generateSingleQuery(containsAny("test", List.of("testValue")),
                new MockMongoEntityMapper()::convertToMongoAttribute);
    ...
    void testGenerateSingleQuery_or() {
        Bson result = QueryUtils.generateSingleQuery(or(List.of(contains("test", "testValue"))),
                new MockMongoEntityMapper()::convertToMongoAttribute);
        assertEquals(Filters.or(Filters.eq("test", "testValue")), result);
    }
    ...
    void testGenerateSingleQuery_and() {
        Bson result = QueryUtils.generateSingleQuery(and(List.of(contains("test", "testValue"))),
                new MockMongoEntityMapper()::convertToMongoAttribute);
    ...
    void testGenerateSingleQuery_not() {
        Bson result = QueryUtils.generateSingleQuery(not(equalTo("test", "testValue")),
                new MockMongoEntityMapper()::convertToMongoAttribute);
