...
class StringEqualArgumentTest extends AbstractStringArgumentTest<String, StringEqualArgument> {

    private static final String VALUE = "VALUE";

    @Override
    protected StringEqualArgument createArgument() {
        return new StringEqualArgument(VALUE);
    }

    @Override
    protected StringEqualArgument createArgument(String value) {
        return new StringEqualArgument(value);
    }

    @Override
    StringArgument.Condition expectedCondition() {
        return StringArgument.Condition.EQUAL;
    }
