...
class DateLessThanEqualArgumentTest extends AbstractDateArgumentTest<ZonedDateTime, DateLessThanEqualArgument> {

    @Override
    protected DateLessThanEqualArgument createArgument() {
        return new DateLessThanEqualArgument(VALUE);
    }

    @Override
    protected DateLessThanEqualArgument createArgument(ZonedDateTime value) {
        return new DateLessThanEqualArgument(value);
    }

    @Override
    DateArgument.Condition expectedCondition() {
        return DateArgument.Condition.LESS_THAN_EQUAL;
    }
