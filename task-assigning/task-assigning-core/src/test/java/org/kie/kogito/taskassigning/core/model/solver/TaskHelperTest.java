...
class TaskHelperTest {
    ...
    static Stream<Arguments> testParams() {
        return Stream.of(
                Arguments.of(LABEL_NAME1, new HashSet<>(Arrays.asList(LABEL_VALUE1, LABEL_VALUE2)), LABEL_NAME1,
                        new HashSet<>(Arrays.asList(LABEL_VALUE1, LABEL_VALUE2)), new LabelsCheckResult(true, 2)),
                Arguments.of(LABEL_NAME1, new HashSet<>(Collections.singletonList(LABEL_VALUE1)), LABEL_NAME1,
                        new HashSet<>(Arrays.asList(LABEL_VALUE1, LABEL_VALUE2)), new LabelsCheckResult(true, 1)),
                Arguments.of(LABEL_NAME1, Collections.emptySet(), LABEL_NAME1,
                        new HashSet<>(Arrays.asList(LABEL_VALUE1, LABEL_VALUE2)), new LabelsCheckResult(true, 0)),
                Arguments.of(LABEL_NAME1, null, LABEL_NAME1, new HashSet<>(Arrays.asList(LABEL_VALUE1, LABEL_VALUE2)),
                        new LabelsCheckResult(true, 0)),
                ...
                Arguments.of(LABEL_NAME1, new HashSet<>(Arrays.asList(LABEL_VALUE1, LABEL_VALUE2)), LABEL_NAME1,
                        new HashSet<>(Collections.singletonList(LABEL_VALUE2)), new LabelsCheckResult(false, 1)),
                Arguments.of(LABEL_NAME1, new HashSet<>(Arrays.asList(LABEL_VALUE1, LABEL_VALUE2)), LABEL_NAME1,
                        new HashSet<>(), new LabelsCheckResult(false, 0)),
                Arguments.of(LABEL_NAME1, new HashSet<>(Arrays.asList(LABEL_VALUE1, LABEL_VALUE2)), LABEL_NAME1, null,
                        new LabelsCheckResult(false, 0)),
                Arguments.of(LABEL_NAME1, new HashSet<>(Arrays.asList(LABEL_VALUE1, LABEL_VALUE2)), LABEL_NAME2,
                        new HashSet<>(Arrays.asList(LABEL_VALUE1, LABEL_VALUE2)), new LabelsCheckResult(false, 0)));
    }
    ...
    void extractTasksFiltered() {
        ChainElement chainElement = buildChainElement();
        List<TaskAssignment> result = TaskHelper.extractTaskAssignments(chainElement,
                testedTask -> testedTask.getId().equals(TASK_ID_1) || testedTask.getId().equals(TASK_ID_4));
