...
import { ProcessInstanceState, GetProcessInstancesDocument } from '../../../../graphql/types';
...
jest.mock('../../../Molecules/DataListItemComponent/DataListItemComponent')
...
describe('DataList component tests', () => {
  it('Snapshot tests 1', async () => {
    const wrapper = await getWrapperAsync(
        <MockedProvider mocks={mocks1} addTypename={false}>
          <BrowserRouter>
            <DataListComponent {...props1} />
          </BrowserRouter>
        </MockedProvider>, 'DataListComponent');
