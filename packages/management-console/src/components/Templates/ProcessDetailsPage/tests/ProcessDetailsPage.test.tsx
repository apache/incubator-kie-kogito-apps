...
import { GetProcessInstanceByIdDocument} from '../../../../graphql/types'
import * as H from 'history';

const props = {
  match: {
    params: { instanceID: '201a8a42-043e-375a-9f52-57c804b24db4' },
    url: '',
    isExact: false,
    path: ''
  },
...
jest.mock('../../../Molecules/ProcessDescriptor/ProcessDescriptor');
jest.mock('../../../Atoms/SpinnerComponent/SpinnerComponent');
jest.mock('../../../Molecules/PageTitleComponent/PageTitleComponent');
jest.mock('../../../Atoms/ProcessBulkModalComponent/ProcessBulkModalComponent');
jest.mock('../../../Organisms/ProcessDetails/ProcessDetails');
jest.mock('../../../Organisms/ProcessDetailsProcessVariables/ProcessDetailsProcessVariables');
