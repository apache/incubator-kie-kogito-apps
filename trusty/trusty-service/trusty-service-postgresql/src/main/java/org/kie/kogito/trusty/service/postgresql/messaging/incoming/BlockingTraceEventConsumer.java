...
import org.kie.kogito.trusty.service.common.messaging.incoming.TraceEventConsumer;
...
public class BlockingTraceEventConsumer extends TraceEventConsumer {

    protected BlockingTraceEventConsumer() {
        //CDI proxy
    }

    @Inject
    public BlockingTraceEventConsumer(TrustyService service, ObjectMapper mapper, StorageExceptionsProvider storageExceptionsProvider) {
