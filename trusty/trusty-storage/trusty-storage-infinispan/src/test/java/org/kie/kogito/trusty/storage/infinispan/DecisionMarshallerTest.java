...
public class DecisionMarshallerTest extends MarshallerTestTemplate<Decision> {
    ...
    private static final List<AbstractTestField<Decision, ?>> TEST_FIELD_LIST = List.of(
            ...
            new StringTestField<>(SOURCE_URL_FIELD, "http://localhost:8080/modelName", Decision::getSourceUrl,
                    Decision::setSourceUrl),
            new LongTestField<>(EXECUTION_TIMESTAMP_FIELD, 0L, Decision::getExecutionTimestamp,
                    Decision::setExecutionTimestamp),
            new StringTestField<>(EXECUTOR_NAME_FIELD, "jack", Decision::getExecutorName, Decision::setExecutorName),
            new StringTestField<>(EXECUTED_MODEL_NAME_FIELD, "modelName", Decision::getExecutedModelName,
                    Decision::setExecutedModelName),
            new StringTestField<>(EXECUTED_MODEL_NAMESPACE_FIELD, "modelNamespace", Decision::getExecutedModelNamespace,
                    Decision::setExecutedModelNamespace),
            new BooleanTestField<>(HAS_SUCCEEDED_FIELD, Boolean.TRUE, Decision::hasSucceeded, Decision::setSuccess),
            new EnumTestField<>(EXECUTION_TYPE_FIELD, ExecutionType.DECISION, Decision::getExecutionType,
                    Decision::setExecutionType, ExecutionType.class),
            new CollectionTestField<>(INPUTS_FIELD, Collections.emptyList(), Decision::getInputs, Decision::setInputs,
                    DecisionInput.class),
            new CollectionTestField<>(OUTCOMES_FIELD, Collections.emptyList(), Decision::getOutcomes, Decision::setOutcomes,
