...
public class MessageMarshallerTest extends MarshallerTestTemplate<Message> {
    ...
    private static final List<AbstractTestField<Message, ?>> TEST_FIELD_LIST = List.of(
            ...
            new ObjectTestField<>(EXCEPTION_FIELD, new MessageExceptionField("exc", "exc message", null), Message::getException,
                    Message::setException, MessageExceptionField.class));
