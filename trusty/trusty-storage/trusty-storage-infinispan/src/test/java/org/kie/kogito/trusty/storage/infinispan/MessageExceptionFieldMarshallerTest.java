...
public class MessageExceptionFieldMarshallerTest extends MarshallerTestTemplate<MessageExceptionField> {
    ...
    private static final List<AbstractTestField<MessageExceptionField, ?>> TEST_FIELD_LIST = List.of(
            new StringTestField<>(CLASS_NAME_FIELD, "class name", MessageExceptionField::getClassName,
                    MessageExceptionField::setClassName),
            new StringTestField<>(MESSAGE_FIELD, "message", MessageExceptionField::getMessage,
                    MessageExceptionField::setMessage),
            new ObjectTestField<>(CAUSE_FIELD, new MessageExceptionField("cause", "cause message", null),
                    MessageExceptionField::getCause, MessageExceptionField::setCause, MessageExceptionField.class));
