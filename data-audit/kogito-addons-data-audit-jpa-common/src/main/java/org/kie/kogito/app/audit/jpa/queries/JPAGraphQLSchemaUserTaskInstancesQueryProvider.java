...
public class JPAGraphQLSchemaUserTaskInstancesQueryProvider implements GraphQLSchemaQueryProvider {
    ...
    public List<GraphQLSchemaQuery<?>> queries() {
        return List.of(
                ...
                new JPASimpleNamedQuery<UserTaskInstanceAssignmentTO>("GetAllUserTaskInstanceAssignments", "GetAllUserTaskInstanceAssignments", UserTaskInstanceAssignmentTO.class));
