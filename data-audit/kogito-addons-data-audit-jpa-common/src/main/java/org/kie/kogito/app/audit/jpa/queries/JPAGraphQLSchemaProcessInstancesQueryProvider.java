...
public class JPAGraphQLSchemaProcessInstancesQueryProvider implements GraphQLSchemaQueryProvider {
    ...
    public List<GraphQLSchemaQuery<?>> queries() {
        return List.<GraphQLSchemaQuery<?>> of(
                new JPAComplexNamedQuery<ProcessInstanceStateTO>("GetAllProcessInstancesState", "GetAllProcessInstancesState", new DataMapper<ProcessInstanceStateTO>() {
                ...
                new JPASimpleNamedQuery<ProcessInstanceVariableTO>("GetAllProcessInstancesVariablebyProcessInstanceId", "GetAllProcessInstancesVariablebyProcessInstanceId",
