...
export type GetUserTasksByStateQuery = { __typename?: 'Query' } & {
    ...
    Array<
      Maybe<
        { __typename?: 'ProcessInstance' } & Pick<
          ProcessInstance,
          'id' | 'processId' | 'processName' | 'endpoint'
        >
      >
    >
  >;
 ...
 * });
 */
export function useGetUserTasksByStateQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    GetUserTasksByStateQuery,
    GetUserTasksByStateQueryVariables
  >
) {
  return ApolloReactHooks.useQuery<
    GetUserTasksByStateQuery,
    GetUserTasksByStateQueryVariables
  >(GetUserTasksByStateDocument, baseOptions);
}
export function useGetUserTasksByStateLazyQuery(
...
export type GetUserTasksByStateQueryHookResult = ReturnType<
  typeof useGetUserTasksByStateQuery
>;
export type GetUserTasksByStateLazyQueryHookResult = ReturnType<
  typeof useGetUserTasksByStateLazyQuery
>;
export type GetUserTasksByStateQueryResult = ApolloReactCommon.QueryResult<
  GetUserTasksByStateQuery,
  GetUserTasksByStateQueryVariables
>;
