...
> &
  ...
  const [detailsResponse, setDetailsResponse] = useState<ProcessInstance>(
    {} as ProcessInstance
  );
  ...
  return (
    <React.Fragment>
      <PageSectionHeader
        ...
        breadcrumbText={['Home', 'Processes', detailsResponse.processName]}
        breadcrumbPath={[
          '/',
      ...
      <PageSection>
        {!isLoading ? (
          <>
            {Object.keys(detailsResponse).length > 0 && !error ? (
