...
public class JPAJobStore implements JobStore {
    ...
    private String buildUpdateQueryWithExistsWhenFiltering(JPAJobContext context, String baseUpdateQuery) {
        ...
        String existsClause = "AND EXISTS (SELECT 1 FROM (" + unionSelects + ") ap WHERE o.processId IS NULL ap.processId = o.rootProcessId OR (o.rootProcessId IS NULL AND ap.processId = o.processId))";
