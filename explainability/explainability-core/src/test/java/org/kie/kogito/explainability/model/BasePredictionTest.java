...
class BasePredictionTest {
    ...
    void testEquality() {
        ...
        PredictionInput input2 = mock(PredictionInput.class);
        PredictionOutput output2 = mock(PredictionOutput.class);
        BasePrediction basePrediction2 = new BasePrediction(input2, output2) {
            @Override
            public PredictionInput getInput() {
                return super.getInput();
            }
