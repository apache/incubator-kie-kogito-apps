...
public interface GlobalExplainer<T> {
     ...
     */
    T explainFromMetadata(PredictionProvider model, PredictionProviderMetadata metadata)
     ...
     * @return a global explanation
     */
    T explainFromPredictions(PredictionProvider model, Collection<Prediction> predictions)
            throws InterruptedException, ExecutionException, TimeoutException;
}
