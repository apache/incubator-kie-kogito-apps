...
public class ExplainabilityMessagingHandlerIT {
    ...
    public void explainabilityRequestIsProcessedAndAResultMessageIsSent() throws Exception {
        ...
        when(explanationService.explainAsync(any(ExplainabilityRequest.class), any(PredictionProvider.class))).thenReturn(CompletableFuture.completedFuture(new ExplainabilityResultDto(executionId, true, Collections.emptyMap())));
