...
public class MultiTenantResolver implements TenantResolver {
    ...
    @Inject
    @ConfigProperty(name = "kogito.dataindex.vertx-graphql.ui.tenant", defaultValue = "web-app-tenant")
    String graphUITenantId;

    @Override
    public String resolve(RoutingContext context) {
        if (graphUIPath!=null && graphUITenantId != null && context.request().path().startsWith(graphUIPath)) {
