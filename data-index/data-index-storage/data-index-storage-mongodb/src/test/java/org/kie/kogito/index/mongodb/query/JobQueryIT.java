...
class JobQueryIT extends QueryTestBase<String, Job> {
    ...
    void test() {
        ...
        Job job1 = TestUtils.createJob(jobId1, processInstanceId1, RandomStringUtils.randomAlphabetic(5),
                UUID.randomUUID().toString(), RandomStringUtils.randomAlphabetic(10), "EXPECTED", 0L);
        Job job2 = TestUtils.createJob(jobId2, processInstanceId2, RandomStringUtils.randomAlphabetic(5), null, null,
                "SCHEDULED", 1000L);
        ...
        queryAndAssert(assertWithIdInOrder(), storage,
                asList(in("id", asList(jobId1, jobId2)),
